namespace FifaWorldCup.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<FifaWorldCup.Models.FifaDB>
    {
        ...
        protected override void Seed(FifaWorldCup.Models.FifaDB context)
        {
            ...
            new Selecoes {Id=1, Nome="Portugal", Emblema="Portugal.png",ImagemPosicoes="SelecaoPortugal.png" ,IndiceGrupo=1},
            new Selecoes {Id=2, Nome="Espanha", Emblema="Espanha.png", ImagemPosicoes="SelecaoEspanha.png" ,IndiceGrupo=1},
            new Selecoes {Id=3, Nome="Irão", Emblema="Irao.png", ImagemPosicoes="SelecaoIrao.png" ,IndiceGrupo=1},
            new Selecoes {Id=4, Nome="Marrocos", Emblema="Marrocos.png", ImagemPosicoes="SelecaoMarrocos.png" ,IndiceGrupo=1},


            //Grupo G
            new Selecoes {Id=5, Nome="Inglaterra", Emblema="Inglaterra.png", ImagemPosicoes="SelecaoInglaterra.png" ,IndiceGrupo=2},
            new Selecoes {Id=6, Nome="Belgica", Emblema="Belgica.png", ImagemPosicoes="SelecaoBelgica.png" ,IndiceGrupo=2},
            new Selecoes {Id=7, Nome="Tunisia", Emblema="Tunisia.png", ImagemPosicoes="SelecaoTunisia.png" ,IndiceGrupo=2},
            new Selecoes {Id=8, Nome="Panama", Emblema="Panama.png", ImagemPosicoes="SelecaoPanama.png" ,IndiceGrupo=2},
            ...
            new Jogadores {Id=1, Nome="H. Kane", Posicao="PLE", Imagem="HarryKane.png", PosicaoImagem="PosicaoPLE.png", IndiceSelecao=5},
            new Jogadores {Id=2, Nome="Sterling", Posicao="PLD", Imagem="Sterling.png", PosicaoImagem="PosicaoPLD.png", IndiceSelecao=5},
            new Jogadores {Id=3, Nome="Dele Ali", Posicao="MCE", Imagem="DeleAli.png", PosicaoImagem="PosicaoMCE.png", IndiceSelecao=5},
            new Jogadores {Id=4, Nome="Henderson", Posicao="MC", Imagem="Henderson.png",  PosicaoImagem="PosicaoMC.png", IndiceSelecao=5},
            new Jogadores {Id=5, Nome="Lingard", Posicao="MCD", Imagem="Lingard.png",  PosicaoImagem="PosicaoMCD.png", IndiceSelecao=5},
            new Jogadores {Id=6, Nome="Young", Posicao="DE", Imagem="Young.png",  PosicaoImagem="PosicaoDE.png", IndiceSelecao=5},
            new Jogadores {Id=7, Nome="Maguire", Posicao="DCE", Imagem="Maguire.png",  PosicaoImagem="PosicaoDCE.png", IndiceSelecao=5},
            new Jogadores {Id=8, Nome="Stones", Posicao="DC", Imagem="Henderson.png",  PosicaoImagem="PosicaoDC.png", IndiceSelecao=5},
            new Jogadores {Id=9, Nome="Walker", Posicao="DCD", Imagem="Walker.png",  PosicaoImagem="PosicaoDCD.png", IndiceSelecao=5},
            new Jogadores {Id=10, Nome="Trippier", Posicao="DD", Imagem="Trippier.png",  PosicaoImagem="PosicaoDD.png", IndiceSelecao=5},
            new Jogadores {Id=11, Nome="Pickford", Posicao="GR", Imagem="Pickford.png",  PosicaoImagem="PosicaoGR.png", IndiceSelecao=5},

            //Jogadores da Belgica
            new Jogadores {Id=12, Nome="Lukaku", Posicao="PL", Imagem="Lukaku.png",  PosicaoImagem="PosicaoPL.png", IndiceSelecao=6},
            new Jogadores {Id=13, Nome="Hazard", Posicao="AE", Imagem="Hazard.png",  PosicaoImagem="PosicaoAE.png", IndiceSelecao=6},
            new Jogadores {Id=14, Nome="Mertens", Posicao="AD", Imagem="Mertens.png",   PosicaoImagem="PosicaoAD.png", IndiceSelecao=6},
            new Jogadores {Id=15, Nome="Carrasco", Posicao="ME", Imagem="Carrasco.png",  PosicaoImagem="PosicaoME.png", IndiceSelecao=6},
            new Jogadores {Id=16, Nome="Witsel", Posicao="MCE", Imagem="Witsel.png",   PosicaoImagem="PosicaoMCE.png", IndiceSelecao=6},
            new Jogadores {Id=17, Nome="De Bruyne", Posicao="MCD", Imagem="DeBruyne.png",  PosicaoImagem="PosicaoMCD.png", IndiceSelecao=6},
            new Jogadores {Id=18, Nome="Meunier", Posicao="MD", Imagem="Meunier.png",   PosicaoImagem="PosicaoMD.png",  IndiceSelecao=6},
            new Jogadores {Id=19, Nome="Vertonghen", Posicao="DCE", Imagem="Vertonghen.png",  PosicaoImagem="PosicaoDCE.png", IndiceSelecao=6},
            new Jogadores {Id=20, Nome="Kompany", Posicao="DC", Imagem="Kompany.png",  PosicaoImagem="PosicaoDC.png", IndiceSelecao=6},
            new Jogadores {Id=21, Nome="Alderweireld", Posicao="DCD", Imagem="Alderweireld.png",  PosicaoImagem="PosicaoDCD.png",  IndiceSelecao=6},
            new Jogadores {Id=22, Nome="Courtois", Posicao="GR", Imagem="Courtois.png",  PosicaoImagem="PosicaoGR.png", IndiceSelecao=6},

            //Jogadores da Tunisia
            new Jogadores {Id=23, Nome="Khazri", Posicao="PL", Imagem="Khazri.png",  PosicaoImagem="PosicaoPL.png", IndiceSelecao=7},
            new Jogadores {Id=24, Nome="Badri", Posicao="ME", Imagem="Badri.png",   PosicaoImagem="PosicaoME.png", IndiceSelecao=7},
            new Jogadores {Id=25, Nome="Khaoui", Posicao="MCE", Imagem="Khaoui.png",  PosicaoImagem="PosicaoMCE.png", IndiceSelecao=7},
            new Jogadores {Id=26, Nome="Sassi", Posicao="MCD", Imagem="Sassi.png",  PosicaoImagem="PosicaoMCD.png", IndiceSelecao=7},
            new Jogadores {Id=27, Nome="B. Youssef", Posicao="MD", Imagem="Ben_Youssef_MD.png",  PosicaoImagem="PosicaoMD.png", IndiceSelecao=7},
            new Jogadores {Id=28, Nome="Skhiri", Posicao="MDC", Imagem="Skhiri.png",  PosicaoImagem="PosicaoMDC.png", IndiceSelecao=7},
            new Jogadores {Id=29, Nome="Maâloul", Posicao="DE", Imagem="Maaloul.png",  PosicaoImagem="PosicaoDE.png", IndiceSelecao=7},
            new Jogadores {Id=30, Nome="Meriah", Posicao="DC", Imagem="Meriah.png",  PosicaoImagem="PosicaoDC.png", IndiceSelecao=7},
            new Jogadores {Id=31, Nome="B. Youssef", Posicao="DC", Imagem="Ben_Youssef_DC.png",   PosicaoImagem="PosicaoDC.png", IndiceSelecao=7},
            new Jogadores {Id=32, Nome="Bronn", Posicao="DD", Imagem="Bronn.png",  PosicaoImagem="PosicaoDD.png",  IndiceSelecao=7},
            new Jogadores {Id=33, Nome="Mustapha", Posicao="GR", Imagem="Mustapha.png",  PosicaoImagem="PosicaoGR.png", IndiceSelecao=7},

            //Jogadores do Panama
            new Jogadores {Id=34, Nome="Perez", Posicao="PL", Imagem="Perez.png", PosicaoImagem="PosicaoPL.png",  IndiceSelecao=8},
            new Jogadores {Id=35, Nome="Rodriguez", Posicao="ME", Imagem="Rodriguez.png", PosicaoImagem="PosicaoME.png",  IndiceSelecao=8},
            new Jogadores {Id=36, Nome="Godoy", Posicao="MCE", Imagem="Godoy.png", PosicaoImagem="PosicaoMCE.png", IndiceSelecao=8},
            new Jogadores {Id=37, Nome="Cooper", Posicao="MCD", Imagem="Cooper.png", PosicaoImagem="PosicaoMCD.png", IndiceSelecao=8},
            new Jogadores {Id=38, Nome="Barcenas", Posicao="MD", Imagem="Barcenas.png", PosicaoImagem="PosicaoMD.png",  IndiceSelecao=8},
            new Jogadores {Id=39, Nome="Gomez", Posicao="MDC", Imagem="Gomez.png", PosicaoImagem="PosicaoMDC.png", IndiceSelecao=8},
            new Jogadores {Id=40, Nome="Davis", Posicao="DE", Imagem="Davis.png", PosicaoImagem="PosicaoDE.png",  IndiceSelecao=8},
            new Jogadores {Id=41, Nome="Escobar", Posicao="DC", Imagem="Escobar.png", PosicaoImagem="PosicaoDC.png",  IndiceSelecao=8},
            new Jogadores {Id=42, Nome="Torres", Posicao="DC", Imagem="Torres.png", PosicaoImagem="PosicaoDC.png",  IndiceSelecao=8},
            new Jogadores {Id=43, Nome="Murillo", Posicao="DD", Imagem="Murillo.png", PosicaoImagem="PosicaoDD.png",  IndiceSelecao=8},
            new Jogadores {Id=44, Nome="Penedo", Posicao="GR", Imagem="Penedo.png", PosicaoImagem="PosicaoGR.png",  IndiceSelecao=8},

            //Jogadores de Portugal
            new Jogadores {Id=45, Nome="C.Ronaldo", Posicao="PLE", Imagem="C_Ronaldo.png", PosicaoImagem="PosicaoPLE.png",   IndiceSelecao=1},
            new Jogadores {Id=46, Nome="A.Silva", Posicao="PLD", Imagem="A_Silva.png", PosicaoImagem="PosicaoPLD.png",   IndiceSelecao=1},
            new Jogadores {Id=47, Nome="J.Mario", Posicao="ME", Imagem="J_Mario.png", PosicaoImagem="PosicaoME.png",  IndiceSelecao=1},
            new Jogadores {Id=48, Nome="Adrien", Posicao="MC", Imagem="Adrien.png", PosicaoImagem="PosicaoMC.png",  IndiceSelecao=1},
            new Jogadores {Id=49, Nome="Quaresma", Posicao="MD", Imagem="Quaresma.png", PosicaoImagem="PosicaoMD.png",   IndiceSelecao=1},
            new Jogadores {Id=50, Nome="W.Carvalho", Posicao="MDC", Imagem="W_Carvalho.png", PosicaoImagem="PosicaoMDC.png",  IndiceSelecao=1},
            new Jogadores {Id=51, Nome="Guerreiro", Posicao="DE", Imagem="Guerreiro.png", PosicaoImagem="PosicaoDE.png",   IndiceSelecao=1},
            new Jogadores {Id=52, Nome="Fonte", Posicao="DC", Imagem="Fonte.png", PosicaoImagem="PosicaoDC.png",   IndiceSelecao=1},
            new Jogadores {Id=53, Nome="Pepe", Posicao="DC", Imagem="Pepe.png", PosicaoImagem="PosicaoDC.png",   IndiceSelecao=1},
            new Jogadores {Id=54, Nome="Cedric", Posicao="DD", Imagem="Cedric.png", PosicaoImagem="PosicaoDD.png",   IndiceSelecao=1},
            new Jogadores {Id=55, Nome="Patricio", Posicao="GR", Imagem="Patricio.png", PosicaoImagem="PosicaoGR.png",   IndiceSelecao=1},
            
            //Jogadores de Espanha
            new Jogadores {Id=56, Nome="Costa", Posicao="PL", Imagem="Costa.png", PosicaoImagem="PosicaoPL.png",   IndiceSelecao=2},
            new Jogadores {Id=57, Nome="Isco", Posicao="EE", Imagem="Isco.png", PosicaoImagem="PosicaoME.png",   IndiceSelecao=2},
            new Jogadores {Id=58, Nome="D.Silva", Posicao="ED", Imagem="D_Silva.png", PosicaoImagem="PosicaoMCE.png",  IndiceSelecao=2},
            new Jogadores {Id=59, Nome="Iniesta", Posicao="MC", Imagem="Iniesta.png", PosicaoImagem="PosicaoMCD.png",  IndiceSelecao=2},
            new Jogadores {Id=60, Nome="Thiago", Posicao="MC", Imagem="Thiago.png", PosicaoImagem="PosicaoMD.png",   IndiceSelecao=2},
            new Jogadores {Id=61, Nome="Busquets", Posicao="MDC", Imagem="Busquets.png",PosicaoImagem="PosicaoMDC.png",  IndiceSelecao=2},
            new Jogadores {Id=62, Nome="J.Alba", Posicao="DE", Imagem="J_Alba.png", PosicaoImagem="PosicaoDE.png",   IndiceSelecao=2},
            new Jogadores {Id=63, Nome="S.Ramos", Posicao="DC", Imagem="S_Ramos.png", PosicaoImagem="PosicaoDC.png",   IndiceSelecao=2},
            new Jogadores {Id=64, Nome="Pique", Posicao="DC", Imagem="Pique.png", PosicaoImagem="PosicaoDC.png",   IndiceSelecao=2},
            new Jogadores {Id=65, Nome="Carvajal", Posicao="DD", Imagem="Carvajal.png", PosicaoImagem="PosicaoDD.png",   IndiceSelecao=2},
            new Jogadores {Id=66, Nome="De Gea", Posicao="GR", Imagem="De_Gea.png", PosicaoImagem="PosicaoGR.png",   IndiceSelecao=2},

            //Jogadores do Irao
            new Jogadores {Id=67, Nome="Azmoun", Posicao="PL", Imagem="Azmoun.png", PosicaoImagem="PosicaoPL.png",  IndiceSelecao=3},
            new Jogadores {Id=68, Nome="Taremi", Posicao="ME", Imagem="Taremi.png", PosicaoImagem="PosicaoME.png",  IndiceSelecao=3},
            new Jogadores {Id=69, Nome="Amiri", Posicao="MC", Imagem="Amiri.png", PosicaoImagem="PosicaoMC.png", IndiceSelecao=3},
            new Jogadores {Id=70, Nome="Ebrahimi", Posicao="MC", Imagem="Ebrahimi.png", PosicaoImagem="PosicaoMC.png", IndiceSelecao=3},
            new Jogadores {Id=71, Nome="Jahanbakhsh", Posicao="MD", Imagem="Jahanbakhsh.png", PosicaoImagem="PosicaoMD.png",  IndiceSelecao=3},
            new Jogadores {Id=72, Nome="Ezatolahi", Posicao="MDC", Imagem="Ezatolahi.png", PosicaoImagem="PosicaoMDC.png", IndiceSelecao=3},
            new Jogadores {Id=73, Nome="Safi", Posicao="DE", Imagem="Safi.png", PosicaoImagem="PosicaoDE.png",  IndiceSelecao=3},
            new Jogadores {Id=74, Nome="Hosseini", Posicao="DC", Imagem="Hosseini.png", PosicaoImagem="PosicaoDC.png",  IndiceSelecao=3},
            new Jogadores {Id=75, Nome="Pouraliganji", Posicao="DC", Imagem="Pouraliganji.png", PosicaoImagem="PosicaoDC.png",  IndiceSelecao=3},
            new Jogadores {Id=76, Nome="Rezaeian", Posicao="DD", Imagem="Rezaeian.png", PosicaoImagem="PosicaoDD.png",  IndiceSelecao=3},
            new Jogadores {Id=77, Nome="Beiranvand", Posicao="GR", Imagem="Beiranvand.png", PosicaoImagem="PosicaoGR.png",  IndiceSelecao=3},

            //Jogadores de Marrocos
            new Jogadores {Id=78, Nome="Boutaib", Posicao="PL", Imagem="Boutaib.png", PosicaoImagem="PosicaoPL.png", IndiceSelecao=4},
            new Jogadores {Id=79, Nome="Ziyach", Posicao="ME", Imagem="Ziyach.png", PosicaoImagem="PosicaoME.png", IndiceSelecao=4},
            new Jogadores {Id=80, Nome="Amrabat", Posicao="MD", Imagem="Amrabat.png", PosicaoImagem="PosicaoMD.png",IndiceSelecao=4},
            new Jogadores {Id=81, Nome="Belhanda", Posicao="MC", Imagem="Belhanda.png", PosicaoImagem="PosicaoMC.png",IndiceSelecao=4},
            new Jogadores {Id=82, Nome="Boussoufa", Posicao="MC", Imagem="Boussoufa.png", PosicaoImagem="PosicaoMC.png", IndiceSelecao=4},
            new Jogadores {Id=83, Nome="Ahmadi", Posicao="MDC", Imagem="Ahmadi.png", PosicaoImagem="PosicaoMDC.png",IndiceSelecao=4},
            new Jogadores {Id=84, Nome="Hakimi", Posicao="DE", Imagem="Hakimi.png", PosicaoImagem="PosicaoDE.png", IndiceSelecao=4},
            new Jogadores {Id=85, Nome="Saiss", Posicao="DC", Imagem="Saiss.png", PosicaoImagem="PosicaoDC.png", IndiceSelecao=4},
            new Jogadores {Id=86, Nome="Benatia", Posicao="DC", Imagem="Benatia.png", PosicaoImagem="PosicaoDC.png", IndiceSelecao=4},
            new Jogadores {Id=87, Nome="Dirar", Posicao="DD", Imagem="Dirar.png", PosicaoImagem="PosicaoDD.png", IndiceSelecao=4},
            new Jogadores {Id=88, Nome="Kajoui", Posicao="GR", Imagem="Kajoui.png", PosicaoImagem="PosicaoGR.png", IndiceSelecao=4},
